-- Barter App Database Schema
-- Run this in Supabase SQL Editor (https://supabase.com/dashboard/project/zycjweqawglcddmfyvvm/sql)
...
-- Index for faster discovery feed queries
...
-- Policies for messages (users can only see messages for offers they're involved in)
...
-- ============================================
-- SWIPES TABLE (for tracking user swipes)
-- ============================================
